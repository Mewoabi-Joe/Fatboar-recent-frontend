export const legalNotice = `<div>
<p>
    La société Fatboar, soucieuse des droits des individus, notamment au regard des traitements automatisés, et dans une volonté de transparence avec ses clients,
    a mis en place une politique reprenant l’ensemble de ces traitements, des finalités poursuivies par ces derniers ainsi que des moyens d’actions à la disposition des individus afin qu’ils puissent au mieux exercer leurs droits.

Pour toute information complémentaire sur la protection des données personnelles, nous vous invitons à consulter le site :<br>
</p>
    <ul>
        <li> <a mat-button rel="noopener noreferrer" href="https://www.cnil.fr/" target="_blank" color="primary">Cnil</a> </li>
    </ul>
...
La version actuellement en ligne de ces conditions d'utilisation est la seule opposable pendant toute la durée d'utilisation du site et jusqu'à ce qu'une nouvelle version la remplace.
    ...
    <h1>    <strong>Article 1 - Mentions légales </strong>
</h1>

<h2>
    <strong>1.1 Site (ci-après « le site ») : Fatboar </strong>
</h2>
<h2>
    <strong>
...
<p>
    ...
    immatriculée au RCS de Paris, 484 969 950, <br>
    n° de téléphone : 01 42 51 62 01, <br>
    adresse mail : contact@fatbor.fr <br>
</p>
    <h2><strong>1.3 Hébergeur (ci-après « l'hébergeur ») :</strong></h2>
<p>
    Gusto coffee est hébergé par Scalway, dont le siège social est au 8 rue de la ville l’évêque 75008 Paris.
</p>

    <h1><strong>Article 2 - Accès au site</strong></h1>
...
<h1><strong>Article 3 - Contenu du site</strong></h1>
    <p>
...
Ils sont la propriété pleine et entière de l'éditeur ou de ses partenaires. Toute reproduction, représentation, utilisation ou adaptation, sous quelque forme que ce soit, de tout ou partie de ces éléments, y compris les applications informatiques, sans l'accord préalable et écrit de l'éditeur, sont strictement interdites. Le fait pour l'éditeur de ne pas engager de procédure dès la prise de connaissance de ces utilisations non autorisées ne vaut pas acceptation desdites utilisations et renonciation aux poursuites.
    ...
    <h1><strong>Article 4 - Gestion du site</strong></h1>
    <p>
...
Si l'éditeur venait à faire l'objet d'une procédure amiable ou judiciaire à raison de votre utilisation du site, il pourrait se retourner contre vous pour obtenir l'indemnisation de tous les préjudices, sommes, condamnations et frais qui pourraient découler de cette procédure.
    ...
    <h1><strong>Article 6 - Liens hypertextes</strong></h1>
    <p>
...
Toute information accessible via un lien vers d'autres sites n'est pas sous le contrôle de l'éditeur qui décline toute responsabilité quant à leur contenu.
    ...
    <h1><strong>Article 7 - Collecte de données</strong></h1>
    <p>
...
Le numéro d’enregistrement de l’éditeur à la CNIL est le suivant : XXXX-XXXX-XXXX-XXXX
    </p>

    <h1><strong>Article 8 - Droit d’accès, de rectification et de déréférencement de vos données</strong></h1>
    <p>
...
De plus, et depuis la loi n°2016-1321 du 7 octobre 2016, les personnes qui le souhaitent, ont la possibilité d’organiser le sort de leurs données après leur décès. Pour plus d’information sur le sujet, vous pouvez consulter le site Internet de la CNIL :
    ...
    <h1><strong>Article 9 - Utilisation des données</strong></h1>
    <p>
...
Lorsque certaines informations sont obligatoires pour accéder à des fonctionnalités spécifiques du site, l'éditeur indiquera ce caractère obligatoire au moment de la saisie des données.
    ...
    <h1><strong>Article 10 - Offres commerciales</strong></h1>
    <p>
...
Les données sont conservées et utilisées pour une durée conforme à la législation en vigueur.
    ...
    <h1><strong>Article 11 - Cookies</strong></h1>
    <p>
...
Les cookies suivants sont présents sur ce site : Cookies de navigation, Cookies de performance.
...
Pour plus d’informations sur l’utilisation, la gestion et la suppression des « cookies », pour tout type de navigateur, nous vous invitons à consulter le lien suivant :  <a href="https://www.cnil.fr/fr/cookies-les-outils-pour-les-maitriser " >Cnil</a>.
    </p>
    <h1><strong>Article 12 - Photographies et représentation des produits</strong></h1>
<p>Les photographies de produits, accompagnant leur description, ne sont pas contractuelles et n'engagent pas l'éditeur.
</p>
    <h1><strong>Article 13 - Loi applicable</strong></h1>
<p>Les présentes conditions d'utilisation du site sont régies par la loi française et soumises à la compétence des tribunaux du siège social de l'éditeur, sous réserve d'une attribution de compétence spécifique découlant d'un texte de loi ou réglementaire particulier.
    ...
    <h1> <strong>Article 14 - Contactez-nous</strong></h1>
    <p>
Pour toute question, information sur les produits présentés sur le site, ou concernant le site lui-même, vous pouvez laisser un message à l'adresse suivante :
    ...
    <strong>contact@fatbor.fr</strong>
</div>
`;
